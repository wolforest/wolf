...
public class RocketTransaction implements Transaction {
    ...
    private cn.coderule.mqclient.core.message.Message message;
    ...
    @Override
    public cn.coderule.mqclient.core.message.Message getMessage() {
        return message;
    }

    @Override
    public void setMessage(cn.coderule.mqclient.core.message.Message message) {
