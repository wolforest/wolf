...
import cn.coderule.mqclient.core.transaction.TransactionChecker;
import cn.coderule.mqclient.core.transaction.TransactionCheckerRegistry;
import cn.coderule.mqclient.core.transaction.TransactionProducer;
import cn.coderule.mqclient.core.transaction.TransactionResult;
import cn.coderule.mqclient.core.transaction.exception.TransactionListenerNotFoundException;
import cn.coderule.mqclient.vendor.rocketmq.converter.MessageConverter;
import cn.coderule.mqclient.vendor.rocketmq.converter.result.TransactionResultConverter;
...
public class RocketTransactionListener implements TransactionListener {
    ...
    public LocalTransactionState executeLocalTransaction(Message rocketMessage, Object arg) {
        ...
        cn.coderule.mqclient.core.message.Message message = MessageConverter.toTransactionMessage(rocketMessage);
