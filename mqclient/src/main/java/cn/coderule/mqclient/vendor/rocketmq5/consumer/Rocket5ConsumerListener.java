package cn.coderule.mqclient.vendor.rocketmq5.consumer;
...
import cn.coderule.mqclient.vendor.rocketmq5.converter.result.ConsumeResultConverter;
...
public class Rocket5ConsumerListener implements MessageListener {
    ...
    public ConsumeResult consume(MessageView messageView) {
        ...
        cn.coderule.mqclient.core.consumer.ConsumeResult result = consumer.consume(messageList);
